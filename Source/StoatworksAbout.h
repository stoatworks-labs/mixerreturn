/*
 * Stoatworks Labs - About window data for MixerReturn.
 *
...
{
    inline constexpr auto name = "MixerReturn";
    inline constexpr auto slug = "mixerreturn";
    inline constexpr auto hook = "Dugan automix, inserts intact";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/mixerreturn/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/mixerreturn/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/mixerreturn";
    inline constexpr auto versionFallback = "v0.4.1";
